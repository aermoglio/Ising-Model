...
int main() {
    int n_configurations = 5000;        // number of configurations to create
    ...
    double T=100;        // we set k at 1, so our units for temperature have now changed to being dimensionless;
